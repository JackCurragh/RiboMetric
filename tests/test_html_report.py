...
def test_build_report_context_groups_and_cards():
    summary = {
        "metrics": [
            {"key": "periodicity_dominance_score", "metric": "periodicity_dominance", "score": 0.82},
            ...
            {"key": "terminal_evenness_kl_5prime_score", "metric": "terminal_bias_kl_5prime", "score": 0.61},
        ]
    }
...
def test_every_score_is_labelled_higher_is_better():
    ...
    summary = {
        "metrics": [
            {"key": "fragment_uniqueness_score", "metric": "duplicate_rate",
             "score": 0.8, "raw": 0.2, "status": "PASS", "tier": 3},
            {"key": "periodicity_dominance_score", "metric": "periodicity_dominance",
             "score": 0.8, "raw": 0.8, "status": "PASS", "tier": 1},
        ]
    }
