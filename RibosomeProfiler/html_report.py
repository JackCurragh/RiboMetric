...
def generate_report(plots_dict: dict, export_mode: str = 'html', name: str = "RibosomeProfiler_report", outdir: str = ''):
    ...
    Inputs:
        results: A dictionary containing the results of the RibosomeProfiler analysis
        export_mode: A string defining the mode of export: 'html','pdf' or 'both' (Default: 'html')
