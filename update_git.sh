...
RiboMetric run -b Calviello16/Calviello.transcriptome.sorted.bam -a Calviello16/gencode.v45_RiboMetric.tsv -S 100000000 --all --offset-calculation-method ribowaltz -o test/ribowaltz
